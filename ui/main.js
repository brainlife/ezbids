    ...
    methods: {
        ...
        dropit(e) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                e.preventDefault();
                this.dragging = false;
                yield this.listDropFiles(e.dataTransfer.items);
                this.upload();
            });
        },
        selectit(e) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                function readAllDirectoryEntries(directoryReader) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        let readEntries = yield readEntriesPromise(directoryReader);
                        while (readEntries.length > 0) {
                            entries.push(...readEntries);
                            readEntries = yield readEntriesPromise(directoryReader);
                        }
                        return entries;
                    });
                }
                ...
                while (queue.length > 0) {
                    ...
                    if (entry.isFile) {
                        console.dir(entry);
                        let file = yield getFile(entry);
                        file.path = entry.fullPath.substring(1); //remove / prefix
                        //file.that = entry.fullPath;
                        this.files.push(file);
                    }
                    else if (entry.isDirectory) {
                        queue.push(...yield readAllDirectoryEntries(entry.createReader()));
                    }
                }
            });
        },
        upload(files) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                //create new session
                const res = yield fetch(apihost + '/session', {
                    method: "POST",
                    /*
                    mode: "cors",
                    cache: "no-cache",
        ...
        process_files() {
            ...
            if (this.uploading.length > 3)
                return; //don't upload more than 3 files concurrently
            //find next file to upload
            let file;
            let idx;
            for (let i = 0; i < this.files.length; ++i) {
                if (this.uploaded.includes(i))
                    continue;
                if (this.uploading.includes(i))
                    continue;
                file = this.files[i];
                idx = i;
                break;
        ...
        done_uploading() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const res = yield fetch(apihost + '/session/uploaded/' + this.session_id, {
                    method: "PATCH",
...
const Session = {
    ...
    methods: {
        load_session() {
            return __awaiter(this, void 0, void 0, function* () {
                const res = yield fetch(apihost + '/session/' + this.session_id, {
                    method: "GET",
                    headers: {
                        'Content-Type': 'application/json'
                    },
                });
                this.session = yield res.json();
