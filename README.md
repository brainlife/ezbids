...
In lieu of DICOMs, users may upload a directory containing the NIFTI/JSON files generated by dcm2niix instead, if they do not have access to the original DICOMs.
